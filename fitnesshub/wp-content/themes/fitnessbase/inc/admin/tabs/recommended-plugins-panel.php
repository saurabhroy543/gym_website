		...
		foreach( $free_plugins as $plugin ) {
			...
			<div class="recom-plugin-wrap mb-0">
				<div class="plugin-title-install clearfix">
					...
					<p><?php esc_html_e('Arile Extra Plugin requires you to be highly recommended. And after installing it, you will be able to show all the front page features and, all business sections of the FrontPage.', 'fitnessbase'); ?></p>
					<?php 
